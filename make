{
  ...
  "story": [
    ...
    },
    {
      "type": "markdown",
      "id": "a2517289bc49b4a1",
      "text": "* a subclass of `[[Form]]` called `[[ObjectForm]]` \n⇒  [[The Smalltalk Space]], section 5.3 of [[A Mentoring Course on Smalltalk]], [[An Efficient Reference Finder]]\n"
    },
    {
      "type": "markdown",
      "id": "516bd856a7762caa",
